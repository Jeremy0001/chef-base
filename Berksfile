...
group :wrapper do
  ...
  cookbook 'w_haproxy', git: 'https://github.com/jeremy0001/w_haproxy.git'
  cookbook 'w_varnish', git: 'https://github.com/jeremy0001/w_varnish.git'
  cookbook 'w_apache', git: 'https://github.com/jeremy0001/w_apache.git'
  cookbook 'w_memcached', git: 'https://github.com/jeremy0001/w_memcached.git'
  cookbook 'w_percona', git: 'https://github.com/jeremy0001/w_percona.git'
  cookbook 'w_mysql', git: 'https://github.com/jeremy0001/w_mysql.git'
